...
* More information about this sample can be found in the IBM developer tutorial [Generate Java Records from COBOL with IBM Developer J2C Tools](https://developer.ibm.com/tutorials/generating-java-records-from-cobol-with-rational-j2c-tools/)
